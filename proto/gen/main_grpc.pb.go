...
func (c *teachersServiceClient) GetTeachers(ctx context.Context, in *GetTeacherRequset, opts ...grpc.CallOption) (*Teachers, error) {
...
func (UnimplementedTeachersServiceServer) GetTeachers(context.Context, *GetTeacherRequset) (*Teachers, error) {
...
func _TeachersService_GetTeachers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeachersServiceServer).GetTeachers(ctx, req.(*GetTeacherRequset))
	}
